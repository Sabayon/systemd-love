...
inherit eutils autotools gnome.org user multilib readme.gentoo toolchain-funcs udev virtualx
...
src_prepare() {
	...
	# Backport from HEAD, fixes systemd runtime detection stuff
	epatch "${FILESDIR}/0001-systemd-simplify-unit-file.patch"
