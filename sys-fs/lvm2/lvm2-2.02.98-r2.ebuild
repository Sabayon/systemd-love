...
src_prepare() {
	...
	epatch "${fedora_fd}"/lvm2-set-default-preferred_names.patch
	epatch "${fedora_fd}"/lvm2-enable-lvmetad-by-default.patch
	epatch "${fedora_fd}"/lvm2-2_02_99-python-remove-liblvm-object.patch
	epatch "${fedora_fd}"/lvm2-2_02_99-python-whitespace-and-conditional-cleanup.patch
	epatch "${fedora_fd}"/lvm2-2_02_99-python-update-example-to-work-with-lvm-object-removal.patch
	epatch "${fedora_fd}"/lvm2-2_02_99-python-implement-proper-refcounting-for-parent-objects.patch
	epatch "${fedora_fd}"/lvm2-2_02_99-properly-set-cookie_set-var-on-dm_task_set_cookie-call.patch
	epatch "${fedora_fd}"/lvm2-2_02_99-hardcode-use_lvmetad0-if-cluster-locking-used-and-issue-warning-msg.patch
	epatch "${fedora_fd}"/lvm2-2_02_99-init-lvmetad-lazily-to-avoid-early-socket-access-on-config-overrides.patch
	epatch "${fedora_fd}"/lvm2-2_02_99-various-updates-and-fixes-for-systemd-units.patch
	epatch "${fedora_fd}"/lvm2-2_02_99-exit-pvscan-cache-immediately-if-cluster-locking-used-or-lvmetad-not-used.patch
	epatch "${fedora_fd}"/lvm2-2_02_99-skip-mlocking-verctors-on-arm-arch.patch
	epatch "${fedora_fd}"/lvm2-2_02_99-fix-autoactivation-to-not-autoactivate-vg-lv-on-each-pv-change.patch
	epatch "${fedora_fd}"/lvm2-2_02_99-synchronize-with-udev-in-pvscan-cache-and-fix-dangling-udev_sync-cookies.patch
	epatch "${fedora_fd}"/lvm2-2_02_99-also-autoactivate-on-coldplug.patch
