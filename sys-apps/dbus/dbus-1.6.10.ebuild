...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/dbus/dbus-1.6.10.ebuild,v 1.9 2013/05/20 17:55:17 ago Exp $
...
src_prepare() {
	...
	# logind + openrc support
	epatch "${FILESDIR}/0001-dbus-userdb-util-use-LOGIND_RUNNING-instead-of-sd_bo.patch"
